...
3. <strong>Song S</strong>, Auty SG, Yee CA, Chalmers K, Pizer SD. Prospective Low-Value Service Composite to Predict Spending and Quality. <em>In preparation.</em> <details class="abstract"><summary>[abstract]</summary><div class="abstract-body">Objective: To develop a practice-level low-value service (LVS) composite for predicting orthopedic spending<br><br>Study Setting and Design: Cross-sectional study of orthopedic practices serving Medicare beneficiaries enrolled in the Veterans Health Administration in 2019. We used a three-step approach: (1) estimating risk-adjusted practice-level rates for five candidate orthopedic LVS measures using hierarchical logistic models; (2) selecting measures predicting higher orthopedic spending without evidence of lower readmission; and (3) constructing volume-weighted composites of standardized rates and comparing their performance with an all-5-LVS composite and Merit-based Incentive Payment System (MIPS) benchmark scores within Hospital Referral Regions.<br><br>Data Sources and Analytic Sample: Medicare Fee-for-Service claims (2017–2020) linked to the Medicare Data on Provider Practice and Specialty file, Master Beneficiary Summary File, and Centers for Medicare and Medicaid Services (CMS) MIPS performance file. The sample included 461,874 Medicare-enrolled veterans with at least one orthopedist visit in 2019, attributed to 5,113 orthopedic practices identified by Tax Identification Number.<br><br>Principal Findings: Advanced back imaging and spinal injection met the prespecified selection criteria. A 1-SD increase in the resulting 2-LVS composite predicted $393.12 higher orthopedic spending (p < .01). Its prediction of 30-day readmission was positive but not statistically significant (0.35 percentage-point increase; 95% CI, −0.50 to 1.20). Neither the all-5-LVS composite nor the MIPS overall score predicted either outcome.<br><br> Conclusion: Outcome-predictive LVS composites may provide a useful approach for measuring orthopedic practice spending performance. However, composite performance was sensitive to specification choices, so policy applications may require careful alignment between measurement design and policy objectives. Outcome-predictive selection criteria may help guide these decisions.</div></details>
